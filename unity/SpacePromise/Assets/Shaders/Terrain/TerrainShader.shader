...
Shader "SP/Terrain/Terrain"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float localCalculateTangents16_g116_g1 = ( 0.0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			float3 temp_cast_0 = (localCalculateTangents16_g116_g1).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Smoothness = saturate( pow( ( 1.0 - ase_vertex3Pos.y ) , 2.5 ) );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=14201
-1433;75;1426;936;2000.453;579.1946;1.6;True;False
Node;AmplifyShaderEditor.PosVertexDataNode;6;-1270.853,432.0054;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-970.0533,614.4053;Float;False;Constant;_Float5;Float 5;1;0;Create;2.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;7;-1008.453,430.4053;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;8;-746.0532,449.6053;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-398.8534,120.0053;Float;False;Constant;_Float6;Float 6;1;0;Create;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-1285.253,169.6053;Float;False;Constant;_Color2;Color 2;0;0;Create;0.3308824,0.3308824,0.3308824,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2;-1294.854,-324.7948;Float;False;Constant;_Color0;Color 0;0;0;Create;0.06325692,0.4779412,0.0832762,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;10;-514.0535,420.8052;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;5;-808.4534,-315.1948;Float;False;Four Splats First Pass Terrain;0;;1;37452fdfb732e1443b7e39720d05b708;6;59;FLOAT4;0,0,0,0;False;60;FLOAT4;0,0,0,0;False;61;FLOAT3;0,0,0;False;57;FLOAT;0.0;False;58;FLOAT;0.0;False;62;FLOAT;0.0;False;6;FLOAT4;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;19;FLOAT;17
Node;AmplifyShaderEditor.ColorNode;3;-1285.253,-81.59467;Float;False;Constant;_Color1;Color 1;0;0;Create;0.9044118,0.8158051,0.4455558,0;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;0;11;5;17
ASEEND*/
//CHKSM=D0EFACECED16E057D3085675C49CC33D72D1D650